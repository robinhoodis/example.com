...
At the end of the lab students will have configured F5 GSLB DNS servers to alternately resolve www.example.com to 203.0.113.9 and 198.51.100.41. Students will then have an opportunity to simulate a real-life failure scenario and observe how BIG-IP DNS responds to mitigate the outage.
