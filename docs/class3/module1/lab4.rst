...
#. bigip2.site1
   ...
   .. admonition:: TMSH
      ...
      tmsh create net self site1_waf_floating_selfip { address 10.1.50.1/24 vlan site1_waf_vlan }
...
#. bigip2.site2
   ...
   .. admonition:: TMSH
      ...
      tmsh create net self site2_waf_floating_selfip { address 10.1.50.1/24 vlan site2_waf_vlan }
